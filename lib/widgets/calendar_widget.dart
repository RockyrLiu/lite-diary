  ...
  Widget _buildHeader() {
    ...
    return Row(
      ...
      children: [
        ...
        Text('$year 年 $month 月', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
  ...
  Widget _buildDayHeaders() {
    ...
    return Row(
      children: dayNames.map((name) {
        return Expanded(
          child: Center(
            child: Text(name, style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
          ),
        );
      }).toList(),
    );
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: isToday ? Border.all(color: Colors.teal) : null,
              ),
              child: Column(
